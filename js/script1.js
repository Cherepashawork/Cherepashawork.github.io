...
"Где река Колыма?","Где река Индигирка?","Где река Анадырь?","Где река Амур?","Где река Аргунь?","Где река Шилка?","Где река Зея?","Где река Уссури?","Где река Бурея?",
"Где Онежское озеро?","Где Ладожское озеро?","Где озеро Имандра?","Где озеро Ильмень?","Где озеро Селигер?","Где Чудское озеро?","Где озеро Эльтон?",
"Где озеро Баскунчак?","Где озеро Чаны?","Где Телецкое озеро?","Где озеро Таймыр?","Где озеро Байкал?"];
let Mreci = new Array();
let Nreci = new Array();
